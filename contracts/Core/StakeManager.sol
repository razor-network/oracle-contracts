...
import "../tokenization/IERC20.sol";
...
contract StakeManager is Initializable, ACL, StakeStorage, Pause {
    ...
    function stake(uint256 epoch, uint256 amount) external initialized checkEpoch(epoch) checkState(parameters.commit()) whenNotPaused {
        ...
        if (stakerId == 0) {
            ...
            IERC20 sToken = IERC20(stakedTokenFactory.createStakedToken(address(this)));
            ...
            IERC20 sToken = IERC20(stakers[stakerId].tokenAddress);
    ...
    function unstake(
        ...
        IERC20 sToken = IERC20(staker.tokenAddress);
