...
contract AssetManager is ACL, AssetStorage {
    ...
    function createJob (
        ...
        external 
        onlyRole(parameters.getAssetCreatorHash()) 
    {
        ...
        onlyRole(parameters.getAssetCreatorHash()) 
    {
        ...
        require(jobs[jobID].active, "Job has been inactivated");
        ...
        onlyRole(parameters.getAssetCreatorHash()) 
    {
        ...
        require(activationMethod<=1,"Range out of bounds");
