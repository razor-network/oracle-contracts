...
contract Parameters is ACL {
    ...
    bytes32 private constant _REWARD_MODIFIER_HASH =
        0xcabcaf259dd9a27f23bd8a92bacd65983c2ebf027c853f89f941715905271a8d;

    // keccak256("ASSET_MODIFIER_ROLE")
    bytes32 private constant _ASSET_MODIFIER_HASH =
        0xca0fffcc0404933256f3ec63d47233fbb05be25fc0eacc2cfb1a2853993fbbe4;
    ...
    function setSlashPenaltyNum(uint256 _slashPenaltyNumerator)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function setSlashPenaltyDenom(uint256 _slashPenaltyDenominator)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
