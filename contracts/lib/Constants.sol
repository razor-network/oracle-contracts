...
library Constants {
    ...
    function getAssetConfirmerHash() public pure returns(bytes32) { return(0xbe7b58e17bf6adaa0f209cd0db8b128282fc68a42f2dd649b4d8ea579f1b078f); /*keccak256("JOB_CONFIRMER_ROLE")*/}
