...
const setupContracts = async () => {
  ...
  const assetManager = await AssetManager.deploy(stateManager.address);
  ...
  const initializeContracts = async () => [
    blockManager.initialize(stakeManager.address, stateManager.address, voteManager.address, assetManager.address),
