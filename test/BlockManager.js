...
describe('BlockManager', function () {
  ...
  describe('SchellingCoin', async () => {
    ...
    it('should be able to initialize', async () => {
      ...
      await schellingCoin.transfer(signers[19].address, tokenAmount('20000'));
    ...
    it('should be able to finalize Dispute', async function () {
      ...
      assertBNEqual(await schellingCoin.balanceOf(signers[19].address), (balanceBeforeAcc19.add(slashPenalty.div('2'))));
    });
