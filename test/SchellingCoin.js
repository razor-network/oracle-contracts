...
// let Constants = artifacts.require('./lib/Constants.sol')
// let Random = artifacts.require('./lib/Random.sol')
// let Structs = artifacts.require('./lib/Structs.sol')
...
//     before(async () => {
//       const constant = await Constants.new()
//       const structs = await Structs.new()

//       await Random.link(constant)
//       await VoteManager.link(constant)
//       await StateManager.link(constant, structs)
//       await StakeManager.link(constant, structs)
//       await JobManager.link(constant, structs)

//       const random = await Random.new()

//       await BlockManager.link(constant)
//       await BlockManager.link(random)

//       const blockManager = await BlockManager.new()
//       const voteManager = await VoteManager.new()
//       const stakeManager = await StakeManager.new()
//       const stateManager = await StateManager.new()
//       const jobManager1 = await JobManager.new()
//       const faucet = await Faucet.new()
//       const delegator = await Delegator.new()
//       const schellingCoin = await SchellingCoin.new(stateManager.address)

//       Constants.setAsDeployed(constant)
//       Structs.setAsDeployed(structs)
//       Random.setAsDeployed(random)
//       BlockManager.setAsDeployed(blockManager)
//       VoteManager.setAsDeployed(voteManager)
//       StakeManager.setAsDeployed(stakeManager)
//       StateManager.setAsDeployed(stateManager)
//       JobManager.setAsDeployed(jobManager1)
//       Faucet.setAsDeployed(faucet)
//       Delegator.setAsDeployed(delegator)
//       SchellingCoin.setAsDeployed(schellingCoin)
...
//       await Promise.all([
//           blockManager.init(stakeManager.address, stateManager.address, voteManager.address, jobManager1.address),
...
//           jobManager1.init(stateManager.address),
//           faucet.init(schellingCoin.address),

//           jobManager1.grantRole(await constant.getJobConfirmerHash(), blockManager.address),
//           blockManager.grantRole(await constant.getBlockConfirmerHash(), voteManager.address),
//           stakeManager.grantRole(await constant.getStakeModifierHash(), blockManager.address),
//           stakeManager.grantRole(await constant.getStakeModifierHash(), voteManager.address),
//           stakeManager.grantRole(await constant.getStakerActivityUpdaterHash(), voteManager.address),

//           delegator.upgradeDelegate(jobManager1.address),
...
//       let commitment1 = web3.utils.soliditySha3(1, root, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9ddd')
...
//       let commitment2 = web3.utils.soliditySha3(1, root, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9111')
//       tx = await schelling.commit(1, commitment2, { 'from': accounts[2]})

//       tree = merkle('keccak256').sync([120, 220, 320, 420, 520, 620, 720, 820, 920])
//      // console.log(tree.root())
//       root = tree.root()
//       let commitment3 = web3.utils.soliditySha3(1, root, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9333')
//       tx = await schelling.commit(1, commitment3, { 'from': accounts[3]})

//       tree = merkle('keccak256').sync([4, 4, 4, 4, 4, 4, 4, 4, 4 ])
//       let commitment4 = web3.utils.soliditySha3(1, tree.root(), '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9444')
//       tx = await schelling.commit(1, commitment4, { 'from': accounts[4]})

//       tree = merkle('keccak256').sync([110, 210, 310, 410, 510, 610, 710, 810, 910 ])
//       let commitment5 = web3.utils.soliditySha3(1, tree.root(), '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9555')
//       tx = await schelling.commit(1, commitment5, { 'from': accounts[5]})

//       //
//       // let commitment7 = web3.utils.soliditySha3(1, tree.root(), '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9777')
//       // tx = await schelling.commit(1, commitment7, { 'from': accounts[7]})
//       // let commitment8 = web3.utils.soliditySha3(1, 161, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9888')
//       // tx = await schelling.commit(1, commitment8, { 'from': accounts[8]})
//       // // //
//       // let commitment9 = web3.utils.soliditySha3(1, 1, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9999')
//       // tx = await schelling.commit(1, commitment9, { 'from': accounts[9]})
//       // // //
//       // let commitment10 = web3.utils.soliditySha3(1, 1000000, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9111')
...
//       //
//       // let commitment8 = web3.utils.soliditySha3(1, 10, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9888')
...
//       await schelling.giveSorted(1, 0, sortedVotes, { 'from': accounts[accounts.length - 1]})
//       console.log('median', median)
//       console.log('median contract', Number((await schelling.disputes(1, accounts[accounts.length - 1])).median))
//       assert(Number((await schelling.disputes(1, accounts[accounts.length - 1])).accWeight) === totalStakeRevealed, 'totalStakeRevealed not matching')
//       assert(Number((await schelling.disputes(1, accounts[accounts.length - 1])).median) === median, 'median not matching')
//       assert(Number((await schelling.disputes(1, accounts[accounts.length - 1])).lastVisited) === sortedVotes[sortedVotes.length - 1], 'lastVisited not matching')
//     })
// // //
...
//       let commitment = web3.utils.soliditySha3(2, root, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9111')
//       tx = await schelling.commit(2, commitment, { 'from': accounts[1]})

//       // let commitment1 = web3.utils.soliditySha3(2, 160, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9000')
...
//       console.log('stakeBefore', stakeBefore)
//       // commitment1 = web3.utils.soliditySha3(2, 160, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9000')
...
//     //   let commitment = web3.utils.soliditySha3(3, root, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9111')
...
//     //   // let commitment1 = web3.utils.soliditySha3(3, 160, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9000')
...
//     //   // let commitment6 = web3.utils.soliditySha3(2, 160, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9000')
...
//     //   let schelling = await Schelling.deployed()
//     //   let sch = await SchellingCoin.deployed()
//     //   // let commitment = web3.utils.soliditySha3(1, 160, '0x727d5c9e6d18ed15ce7ac8d3cce6ec8a0e9c02481415c0823ea49d847ccb9ddd')
